function hm = Separacao_kernel(h,N,L,fs)
...
%------------- BEGIN CODE --------------
inicioIR =       750705 - 3.6480e+04;
finalIR =      750705 + 3.6480e+04;

len_IR = finalIR - inicioIR  ;

pre_IR =    length(h) - 750000;

%N = 8; % number of harmonics to study
dt = L.*log(1:N).*fs;
